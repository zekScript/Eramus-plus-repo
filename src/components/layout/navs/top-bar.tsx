  ...
  return (
    ...
    <div className='fixed left-0 top-0 z-50 w-full bg-[#FAFAFA] bg-opacity-60 backdrop-blur-sm dark:bg-[#0e0e0e] dark:bg-opacity-50'>
      ...
      >
        ...
        >
          <div className='flex w-full justify-start'>
            {/* LOGO */}
            <Link href='/'>
              <Icons.logo className='w-40  cursor-pointer fill-primary logo-icon pb-1' />
            </Link>
          </div>
      ...
      <div className='flex h-full w-full justify-end'>
        <div
          className={`mb-4 ml-8 mr-8 hidden w-full justify-end border-t-2 border-theme lg:flex`}
        >
          <div className='mt-5'>
